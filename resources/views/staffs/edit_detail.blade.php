...
<header id="header" role="">
    ...
    <div id='cssmenu' style="margin-left: 0%;width:100%; height:80px">
        <ul style="margin-top: 1%;">
            ...
            <li class='active'><a href='/edit_detail'><b>Edit Detail</b></a></li>
    ...
    <div class="container">
        <div class="box first" STYLE="margin-top:2%">
            ...
            <div style="border:2px solid #c0c0c0; margin-left: 5%; width: 90%; border-radius: 10px 10px;">
                ...
                <form class="" method="post" action="/edit_detail" role="form" style="margin-top: -2.5%;margin-left: 5%">
                    ...
                    <div class="row" style="margin-top: 0%; margin-left: 5%;">
                        ...
                        <div class="col-sm-6" style="" id="" >
                            <div class="" style="">
                                ...
                                <table style="margin-left: 0%; width: 90%" cellpadding="7" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td width="80%">
                                            ...
                                            <td width="20%">
                                                <button style="width: 100%" type="submit" class="btn btn-primary "><b>Edit</b></button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="row" style="margin-top: 0%; margin-left: 5%;">
                        ...
                        <div class="col-sm-6" style="" id="" >
                            <div class="" style="">
                                ...
                                {{--<div class="form-group col-sm-3">--}}
                                    {{--<div class="form-group">--}}
                                        {{--<center><button style="" type="submit" class="btn btn-primary "><b>Edit</b></button></center>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            </div>
                        </div>
                    ...
                    <div class="row" style="margin-top: 0%; margin-left: 5%;">
                        ...
                        <div class="col-sm-6" style="" id="" >
                            <div class="" style="">
                                ...
                                {{--<div class="form-group col-sm-3">--}}
                                    {{--<div class="form-group">--}}
                                        {{--<center><button style="width:100%" type="submit" class="btn btn-primary "><b>Edit</b></button></center>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            </div>
                        </div>
