                    ...
                    <div class="tab-pane active" id="tab1">
                        <div style="border:2px solid #c0c0c0; margin-left: 5%; width: 90%; border-radius: 10px 10px;">
                            ...
                            <div class="row" style="margin-top: 5%">
                                ...
                                <form class="" enctype="multipart/form-data" method="post" action="/upload" role="form" style="margin-left: 2%">
                                    ...
                                    <div class="col-sm-6" style="margin-left: 0%;" id="" >
                                        <table style="margin-left: 8%; width: 90%" cellpadding="7" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td width="90%">
